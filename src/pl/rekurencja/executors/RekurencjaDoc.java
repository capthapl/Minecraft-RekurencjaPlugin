    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        if (command.getName().equalsIgnoreCase("rekurencjaDoc")) { // If the player typed /basic then do the following, note: If you only registered this executor for one command, you don't need this
            commandSender.sendMessage(new String[] {
                    ...
                    ChatColor.GOLD+"       Miecz Pełni Księżyca",
                    "",
                    "   Dodany Phantom Dancer",
                    ChatColor.DARK_AQUA+ "   Loot:",
                    "       Bandaz/Magiczny bandaz",
                    "       Azure bluet/Ksiazka/Sztabka zlota",
                    "       Butelki XP/Strzaly/Nitka/Zlote jablko",
                    ChatColor.GOLD+"       Minimalna szansa - Luk (Power 4, Infinity, Flame)",
                    ChatColor.GOLD+"       Luk z rogu jelenia",
                    ...
                    ChatColor.YELLOW+ "   Łuk z rogu jelenia",
                    ChatColor.GOLD+ "   - Łuk ze zmienionymi losowymi procentowymi obrażeniami",
                    "",
                    ChatColor.YELLOW+ "   Miecz Pełni księżyca",
                    ChatColor.GOLD+ "   - Miecz ze zmienionymi losowymi procentowymi obrażeniami",
                    "",
